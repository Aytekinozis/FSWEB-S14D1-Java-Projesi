...
### Silindir
* com.workintech.cylinder.Circle isimli bir sınıf yazınız. ```radius``` isimli bir tane sınıf değişkenine sahip olmalı. radius değişkeninin tipi ne olmalı ?
...
* Cylinder isminde bir sınıf yazınız. com.workintech.cylinder.Circle sınıfı ile arasında kalıtım ilişkisi kurmalısınız.
